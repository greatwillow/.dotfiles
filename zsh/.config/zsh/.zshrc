...
ZSH_PLUGINS_DIRECTORY="$ZSH_CONFIG_DIRECTORY/.zsh_plugins.sh"
ANTIDOTE_CONFIG_DIRECTORY="$BASE_CONFIG_DIRECTORY/antidote"
NIX_SHELL_DIRECTORY="~/.nix-profile/etc/profile.d/nix.sh"
...
# Nix
[[ -e $NIX_SHELL_DIRECTORY ]] && source $NIX_SHELL_DIRECTORY
